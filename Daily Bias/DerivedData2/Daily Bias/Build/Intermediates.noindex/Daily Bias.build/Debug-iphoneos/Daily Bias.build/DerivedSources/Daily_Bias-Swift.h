...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Daily_Bias",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10Daily_Bias28BiasDefinitionViewController")
...
SWIFT_CLASS("_TtC10Daily_Bias29SearchBiasTableViewController")
@interface SearchBiasTableViewController : UITableViewController <UISearchBarDelegate>
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified bias;
- (void)viewDidLoad;
